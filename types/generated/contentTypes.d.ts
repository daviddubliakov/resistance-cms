...
export interface ApiDeputyDeputy extends Struct.CollectionTypeSchema {
...
export interface ApiShameShame extends Struct.CollectionTypeSchema {
  collectionName: 'shames';
  info: {
    displayName: '\u0417\u0430\u0448\u043A\u0432\u0430\u0440';
    pluralName: 'shames';
    singularName: 'shame';
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::shame.shame'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    resources: Schema.Attribute.Component<'resource.resource', true> &
      Schema.Attribute.Required;
